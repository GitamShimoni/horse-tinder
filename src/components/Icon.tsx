...
/**
 * Icon — curated Lucide glyph set (24×24, stroke-based) used across Trotr.
 * Paths are lifted verbatim from lucide.dev (ISC licensed). Inherits color
 * via `currentColor` and scales with `size`.
 */
const GLYPHS = {
  heart:
